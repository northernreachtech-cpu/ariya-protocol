...
fun init(otw: NFT_MINTING, ctx: &mut TxContext) {
    ...
    display::add(&mut poa_display, string::utf8(b"project_url"), string::utf8(b"https://ariyaprotocol.com"));
    ...
    display::add(&mut completion_display, string::utf8(b"project_url"), string::utf8(b"https://ariyaprotocol.com"));
