    ...
    <div className="min-h-screen bg-background pt-20 pb-6 sm:pb-10">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-8 sm:mb-12">
            <div className="flex items-center justify-center gap-4 mb-4">
              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-livvic font-bold text-foreground">
                My Events
              </h1>
              <Button
                variant="outline"
            ...
            <p className="text-foreground-secondary text-base sm:text-lg lg:text-xl max-w-2xl mx-auto font-open-sans">
          ...
          {filteredEvents.length === 0 && !loading && (
            <div className="text-center py-12 sm:py-16">
              ...
              <h3 className="text-xl font-semibold mb-2 text-foreground-muted">
      ...
      {showRatingModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-background/70 backdrop-blur-sm animate-fade-in">
          <div className="relative bg-card backdrop-blur-2xl border border-border shadow-2xl rounded-2xl max-w-md w-full mx-4 p-0 overflow-hidden animate-slide-up">
            {/* Top Icon */}
            ...
            <div className="px-8 py-6 flex flex-col gap-4">
              ...
              <textarea
                className="w-full border-0 bg-card-secondary rounded-xl p-3 text-sm text-foreground focus:ring-2 focus:ring-primary/40 transition outline-none placeholder:text-foreground-muted"
                rows={3}
