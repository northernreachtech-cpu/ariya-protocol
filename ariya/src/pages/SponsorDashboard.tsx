  ...
  <Card className="p-4 sm:p-6 animate-pulse">
    <div className="flex items-start justify-between mb-4">
      <div className="flex-1">
        <div className="h-6 bg-foreground-muted/20 rounded mb-2 w-3/4"></div>
        <div className="h-4 bg-foreground-muted/20 rounded w-full mb-2"></div>
        <div className="flex items-center gap-2 mb-2">
          <div className="h-5 bg-foreground-muted/20 rounded w-16"></div>
    ...
    <div className="space-y-2 mb-4">
      <div className="flex items-center">
        <div className="h-4 w-4 bg-foreground-muted/20 rounded mr-2"></div>
        <div className="h-4 bg-foreground-muted/20 rounded w-20"></div>
      </div>
      <div className="flex items-center">
        <div className="h-4 w-4 bg-foreground-muted/20 rounded mr-2"></div>
        <div className="h-4 bg-foreground-muted/20 rounded w-24"></div>
      </div>
    </div>

    <div className="flex gap-2">
      <div className="h-8 bg-foreground-muted/20 rounded flex-1"></div>
      <div className="h-8 bg-foreground-muted/20 rounded flex-1"></div>
    </div>
  </Card>
);
  ...
  <Card className="p-4 sm:p-6 animate-pulse">
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      <div className="flex flex-col justify-between">
        <div className="mb-4">
          <div className="h-6 bg-foreground-muted/20 rounded mb-2 w-3/4"></div>
          <div className="h-4 bg-foreground-muted/20 rounded w-full mb-3"></div>
        ...
        <div className="bg-card-secondary rounded-lg p-3">
          <div className="h-3 bg-foreground-muted/20 rounded w-24 mb-1"></div>
          <div className="h-5 bg-foreground-muted/20 rounded w-20"></div>
        </div>
      </div>
      <div className="space-y-4">
        <div>
          <div className="flex items-center justify-between mb-2">
            <div className="h-4 bg-foreground-muted/20 rounded w-16"></div>
            <div className="h-4 bg-foreground-muted/20 rounded w-12"></div>
          </div>
          <div className="w-full bg-foreground-muted/20 rounded-full h-2"></div>
        </div>
        <div>
          <div className="flex items-center justify-between mb-2">
            <div className="h-4 bg-foreground-muted/20 rounded w-20"></div>
        ...
        <div className="h-8 bg-foreground-muted/20 rounded"></div>
      </div>
    </div>
  </Card>
);
