  ...
  const [messages] = useState<Message[]>([
    {
      ...
      content:
        "Just finished organizing an amazing Web3 conference! The energy from the community was incredible. Thanks to everyone who attended! ���",
    ...
    },
    {
      ...
      content:
        "Looking for feedback on sponsorship packages for upcoming DeFi events. What value propositions matter most to organizers?",
    ...
    },
    {
      ...
      content:
        "Pro tip: Always have a backup plan for outdoor events. Weather can be unpredictable, but great planning makes all the difference! ⛈️→☀️",
            ...
            <Card className="max-w-md mx-auto p-6 sm:p-8 text-center">
              <div className="mb-6">
                ...
                <p className="text-white/60 leading-relaxed">
                  This community hub is exclusive to EIA Protocol badge holders.
                  Connect your wallet to verify your membership.
                </p>
              </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
          ...
          <div className="space-y-4 sm:space-y-6">
            {messages.map((message) => (
              <Card
                key={message.id}
                className="p-4 sm:p-6 hover:shadow-lg hover:shadow-primary/5 transition-all duration-300 border border-white/10 hover:border-primary/20"
              >
                <div className="flex flex-col sm:flex-row items-start gap-4">
                  <div className="flex-shrink-0">
                    <UserAvatarBadge
          ...
          <Card className="p-4 sm:p-6 mt-8 bg-gradient-to-r from-primary/5 to-secondary/5 border-primary/20">
            ...
            <ul className="text-sm text-white/70 space-y-2 leading-relaxed">
              ...
              <li>
                • Share valuable insights about event organization and Web3
              </li>
